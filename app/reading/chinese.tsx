...
const styles = StyleSheet.create({
  ...
  luckyItem: {
    backgroundColor: COLORS.glassHighlight, borderRadius: BORDER_RADIUS.md, padding: SPACING.md,
  },
  ...
  animalChipGood: { borderColor: COLORS.success, backgroundColor: COLORS.glassBg },
  animalChipGrowth: { borderColor: COLORS.warning, backgroundColor: COLORS.glassBg },
  ...
  pillarCard: {
    ...
    backgroundColor: COLORS.glassHighlight, borderRadius: BORDER_RADIUS.md, padding: SPACING.sm,
  },
