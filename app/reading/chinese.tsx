...
const styles = StyleSheet.create({
  ...
  luckyItem: {
    backgroundColor: 'rgba(255,255,255,0.55)', borderRadius: BORDER_RADIUS.md, padding: SPACING.md,
  },
  ...
  animalChipGood: { borderColor: COLORS.success, backgroundColor: 'rgba(255, 255, 255, 0.58)' },
  animalChipGrowth: { borderColor: COLORS.warning, backgroundColor: 'rgba(255, 255, 255, 0.58)' },
  animalChipEmoji: { fontSize: 16 },
  animalChipText: { color: COLORS.textPrimary, fontSize: 12, fontWeight: '600' },
  ...
  pillarCard: {
    ...
    backgroundColor: 'rgba(255,255,255,0.58)', borderRadius: BORDER_RADIUS.md, padding: SPACING.sm,
  },
  ...
  pillarStem: { color: COLORS.textPrimary, fontSize: 12, fontWeight: '700', marginTop: 2 },
