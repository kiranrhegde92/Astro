...
exports.calculateChineseChart = calculateChineseChart;
...
function getDayPillar(date) {
    const jd = Math.floor(Date.UTC(date.getUTCFullYear(), date.getUTCMonth(), date.getUTCDate()) / 86400000) + 2440588; // Unix epoch to JD offset
...
function calculateChineseChart(birthDate) {
    ...
    return {
        ...
        luckyColors: luckyElements.flatMap(e => { var _a; return (_a = COLOR_MAP[e]) !== null && _a !== void 0 ? _a : []; }),
        luckyNumbers: luckyElements.flatMap(e => { var _a; return (_a = LUCKY_NUMBERS[e]) !== null && _a !== void 0 ? _a : []; }),
    };
}
